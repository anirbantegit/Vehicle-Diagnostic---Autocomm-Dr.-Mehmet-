...
class Settings:
    ...
    admin_session_ttl_seconds: int = env_int("ADMIN_SESSION_TTL_SECONDS", 43200)
    admin_session_cookie_name: str = "diagnostic_bridge_admin_session"
    ...
    @property
    def admin_secret_file(self) -> Path:
        return self.secrets_dir / "admin_secret"
    ...
    @property
    def engine_profiles_file(self) -> Path:
        return self.data_dir / "engine_profiles.json"
